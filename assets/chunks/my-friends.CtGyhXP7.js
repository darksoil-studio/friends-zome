							...
							>
								...
								<sl-dialog id="dialog-${t}" .label=${g("Remove Friend")}>
									...
									<sl-button
										slot="footer"
										variant="danger"
										@click=${async i=>{const o=i.target;o.loading=!0;try{await this.store.client.removeFriend(s.agents)}catch(n){de(g("Failed to remove friend.")),console.error(n)}o.loading=!1,this.shadowRoot.querySelector(`sl-dialog#${t}`).hide()}}
