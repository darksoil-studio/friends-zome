...
`,Z=class extends D{constructor(){super(...arguments),this.hasSlotController=new R(this,"footer","header","image")}render(){return d`
      <div
        part="base"
...
`,yt=(t="value")=>(e,i)=>{const r=e.constructor,o=r.prototype.attributeChangedCallback;r.prototype.attributeChangedCallback=function(n,u,b){var O;const C=r.getPropertyOptions(t),et=typeof C.attribute=="string"?C.attribute:t;if(n===et){const $=C.converter||j,B=(typeof $=="function"?$:(O=$==null?void 0:$.fromAttribute)!=null?O:j.fromAttribute)(b,C.type);this[t]!==B&&(this[i]=B)}o.call(this,n,u,b)}},wt=k`
